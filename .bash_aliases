...
alias cpu='watch -n 1 vcgencmd measure_clock arm'
...
alias temp='watch -n 2 vcgencmd measure_temp'
alias indigo='indigo_server indigo_ccd_qhy indigo_mount_synscan indigo_ccd_asi indigo_focuser_mypro2 -i /usr/bin/indi_servoblaster_cap & sudo servod --p1pins=11'
